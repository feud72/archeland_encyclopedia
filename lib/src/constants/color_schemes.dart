...
class ElementColor {
  static const fire = Color(0xFFDC4041);
  static const water = Color(0xFF2FB3F3);
  static const electric = Color(0xFF5AD941);
  static const light = Color(0xFFDFBC54);
  static const dark = Color(0xFF9861D8);
}

final Map<String, Color> elementColor = {
  "불": const Color(0xFFDC4041),
  "물": const Color(0xFF2FB3F3),
  "번개": const Color(0xFF5AD941),
  "빛": const Color(0xFFFAD55B),
  "어둠": const Color(0xFF9861D8),
};
