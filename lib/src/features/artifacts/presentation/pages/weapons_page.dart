...
import 'package:archeland_encyclopedia/src/features/artifacts/presentation/widgets/weapon_widget.dart';
import 'package:archeland_encyclopedia/src/features/search/query_provider.dart';
import 'package:firebase_ui_firestore/firebase_ui_firestore.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class WeaponsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return FirestoreListView(
      ...
      itemBuilder: (context, doc) {
        final weapon = doc.data();
        return ref
                .read(artifactsScreenControllerProvider.notifier)
                .isQueryMatched(weapon, query)
            ? Column(
                children: [
                  WeaponWidget(weapon: weapon),
                  Padding(
